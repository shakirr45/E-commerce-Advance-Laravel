						...
						<div class="owl-carousel owl-theme reviews_slider">
							...
							<div class="owl-item">
								<div class="review d-flex flex-row align-items-start justify-content-start">
									<div><div class="review_image"><img src="{{ asset('public/frontends') }}/images/review_1.jpg" alt=""></div></div>
							...
							<div class="owl-item">
								<div class="review d-flex flex-row align-items-start justify-content-start">
									<div><div class="review_image"><img src="{{ asset('public/frontends') }}/images/review_2.jpg" alt=""></div></div>
									<div class="review_content">
							...
							<div class="owl-item">
								<div class="review d-flex flex-row align-items-start justify-content-start">
									<div><div class="review_image"><img src="{{ asset('public/frontends') }}/images/review_3.jpg" alt=""></div></div>
									<div class="review_content">
