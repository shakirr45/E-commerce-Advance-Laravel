			...
			<div class="row">
				<div class="col">
					<div class="blog_posts d-flex flex-row align-items-start justify-content-between">
						...
						<!-- Blog post -->
						<div class="blog_post">
							<div class="blog_image" style="background-image:url({{ asset('public/frontends') }}/images/blog_1.jpg)"></div>
						...
						<!-- Blog post -->
						<div class="blog_post">
							<div class="blog_image" style="background-image:url({{ asset('public/frontends') }}/images/blog_2.jpg)"></div>
						...
						<!-- Blog post -->
						<div class="blog_post">
							<div class="blog_image" style="background-image:url({{ asset('public/frontends') }}/images/blog_3.jpg)"></div>
						...
						<!-- Blog post -->
						<div class="blog_post">
							<div class="blog_image" style="background-image:url({{ asset('public/frontends') }}/images/blog_4.jpg)"></div>
						...
						<!-- Blog post -->
						<div class="blog_post">
							<div class="blog_image" style="background-image:url({{ asset('public/frontends') }}/images/blog_5.jpg)"></div>
						...
						<!-- Blog post -->
						<div class="blog_post">
							<div class="blog_image" style="background-image:url({{ asset('public/frontends') }}/images/blog_6.jpg)"></div>
						...
						<!-- Blog post -->
						<div class="blog_post">
							<div class="blog_image" style="background-image:url({{ asset('public/frontends') }}/images/blog_7.jpg)"></div>
						...
						<!-- Blog post -->
						<div class="blog_post">
							<div class="blog_image" style="background-image:url({{ asset('public/frontends') }}/images/blog_8.jpg)"></div>
						...
						<!-- Blog post -->
						<div class="blog_post">
							<div class="blog_image" style="background-image:url({{ asset('public/frontends') }}/images/blog_9.jpg)"></div>
